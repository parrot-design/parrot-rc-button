...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var a=0;for(o=Object.getOwnPropertySymbols(e);a<o.length;a++)t.indexOf(o[a])<0&&Object.prototype.propertyIsEnumerable.call(e,o[a])&&(r[o[a]]=e[o[a]])}return r}(e,["prefixCls","componentName","children","className","size","color","type","shape","outline","loading","style","onClick"]),h=r+"-"+o;return n.default.createElement(l.default,Object.assign({className:i.default(h,s,{[`${h}-${p}`]:p,[`${h}-color-${f}-${u}`]:u&&!m,[`${h}-type-${f}`]:f&&!m,[`${h}-${d}`]:d,[`${h}-outline-${u}`]:u&&m,[`${h}-loading`]:y}),style:b,disableTouchRipple:y,ref:t,component:"button",onClick:g},j),y&&n.default.createElement(c.default,{size:18,style:{marginRight:6},color:"inherit"}),a)}));return n.default.memo(s)}));
